  ...
  return (
    <button type="button" aria-label="輕觸紙船，讀一則船訊" onClick={onTap} onAnimationEnd={event => {
      ...
      <span className="drift-float">
        ...
        <span className="boat-water-occlusion" />
      ...
      <style>{`
        ...
        .boat-water-occlusion{position:absolute;z-index:4;left:50%;top:43%;width:clamp(142px,14.5vw,214px);height:23px;transform:translateX(-50%);background-image:url('/assets/water-desktop-loop.webp');background-attachment:fixed;background-position:center;background-size:cover;clip-path:polygon(0 44%,8% 30%,18% 41%,30% 18%,42% 35%,54% 22%,66% 39%,78% 19%,90% 34%,100% 25%,100% 100%,0 100%);filter:brightness(.82) saturate(.86);opacity:.9;pointer-events:none}
