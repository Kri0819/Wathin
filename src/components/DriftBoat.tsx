  ...
  return (
    <button type="button" aria-label="輕觸紙船，讀一則船訊" onClick={onTap} onAnimationEnd={event => {
      ...
      <style>{`
        ...
        .drift-float svg{width:clamp(142px,15vw,220px);height:auto}.boat-ripple-one{width:clamp(156px,17vw,244px)}.boat-ripple-two{width:clamp(116px,13vw,186px);animation-delay:-1.1s;opacity:.55}
        ...
        @media(max-width:480px){.drift-boat{left:-180px;width:168px;height:145px}.drift-float svg{width:${BOAT.mobileScale}px;height:auto}.boat-ripple-one{width:150px}.boat-ripple-two{width:112px}}
